...
function renderWindow(node, container, options, windowWidth, windowHeight) {
    ...
    var width = options.type === "view" ? options.width : documentWidth(clonedWindow.document);
    var height = options.type === "view" ? options.height : documentHeight(clonedWindow.document);
